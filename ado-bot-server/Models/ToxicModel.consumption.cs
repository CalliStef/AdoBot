...
public partial class ToxicModel
    {
        ...
        {
            [LoadColumn(0)] [ColumnName(@"id")] public string Id { get; set; }

            [LoadColumn(1)]
            [ColumnName(@"comment_text")]
            public string Comment_text { get; set; }

            [LoadColumn(2)] [ColumnName(@"toxic")] public string Toxic { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"comment_text")] public float[] Comment_text { get; set; }

            [ColumnName(@"toxic")] public uint Toxic { get; set; }

            [ColumnName(@"severe_toxic")] public float[] Severe_toxic { get; set; }

            [ColumnName(@"obscene")] public float[] Obscene { get; set; }

            [ColumnName(@"threat")] public float[] Threat { get; set; }

            [ColumnName(@"insult")] public float[] Insult { get; set; }

            [ColumnName(@"identity_hate")] public float[] Identity_hate { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            {
                throw new Exception(
                    "toxic column not found. Make sure the name searched for matches the name in the schema.");
            }
